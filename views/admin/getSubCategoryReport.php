<div class="main-panel">
 ...
 -->
								...
								<button  id="btnExportReportSubCat" name="btnExportReportSubCat" class="btn btn-round" style="background-color: skyblue; color:black;">Export to excel</button>

								<a href="<?php echo base_url('backend/');?>Category/manageSubCategory" class="btn  btn-round" style="background-color: white; color:black;">back</a>
							</div>
						</div>
					</div>
				</div>

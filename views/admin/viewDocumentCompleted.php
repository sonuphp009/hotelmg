                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-lg-5">
                          <div class="row">
                            <div class="col-lg-12">
                              <h3>Post Completed Document</h3>
                            </div><br/>
                            <div class="col-lg-12">
                              
                              <embed src="<?php echo base_url().$postInfo['complete_documet']?>" width="400px" height="300px" />
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-12 text-center">
                              <a href="<?php echo base_url().$postInfo['complete_documet']?>" class="btn btn-danger btn-block" download>Download</a>
                            </div>
                          </div>
                      </div>

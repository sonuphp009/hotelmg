			...
			<div class="page-inner py-5">
				<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
					...
					<div class="ml-md-auto py-2 py-md-0">
						<a href="<?php echo base_url('backend/');?>Category/addSubCategory" class="btn  btn-round" style="background-color: white; color:black;">Add Sub Category</a>

						<a href="<?php echo base_url('backend/');?>Category/getSubCategoryReport/<?php if($this->uri->segment(4)!=""){ echo $this->uri->segment(4);}?>/<?php if($this->uri->segment(5)!=""){ echo $this->uri->segment(5);}?>/<?php if($this->uri->segment(6)!=""){ echo $this->uri->segment(6);}?>" class="btn  btn-round" style="background-color: skyblue; color:black;">Export to excel</a>
					</div>
				</div>
			</div>
		</div>
					...
					<section class="card">
						<header class="card-header">
												...
												<div class="card-body">
													...
													<?php }?>
													<form class="needs-validation" name="frm_manage_cuisines" id="frm_manage_cuisines" method="post" action="<?php echo base_url();?>backend/Category/msubcatsearch/<?php if($this->uri->segment(4)!=""){ echo $this->uri->segment(4);}?>/<?php if($this->uri->segment(5)!=""){ echo $this->uri->segment(5);}?>">
														<div class="row">
															<div class="col-md-3 xl-30">
																<input type="text" name="cuisine_title" id="cuisine_title" placeholder="Enter Sub Category" class="form-control" value="<?php  if($this->uri->segment(4)!='Na'){ echo $this->uri->segment(4);}?>">
															</div>
															...
															<div class="col-md-3 xl-30" >
																<select name="main_cat_id" id="main_cat_id" class="custom-select">
																<option value="">--Category--</option>
																<?php if(isset($main_catlist) && count($main_catlist)>0){
																foreach($main_catlist as $main) {?>
																<option value="<?php echo $main['category_id'];?>" <?php if($this->uri->segment(6)==$main['category_id']){ echo 'selected="selected"';}?>><?php echo $main['category_name'];?></option>
																<?php }
																}?>																		
																	</select>
															</div>
																			...
																			<table class="table table-striped table-bordered" id="datatable" width="100%">
																				<thead>
																					<tr>
																						...
																						<th style="color:#000000;">Sub Category Name</th>
																				...
																				<tbody>
																					...
																					<tr class="odd gradeX">
																						...
																						<td style="text-align:center;">
																							<a href="<?php echo base_url();?>backend/Category/updateSubCategory/<?php echo base64_encode($row['subcategory_id']);?>" >
																								...
																								<a href="<?php echo base_url();?>backend/Category/deleteSubCategory/<?php echo base64_encode($row['subcategory_id']);?>" > 

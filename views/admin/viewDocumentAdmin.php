                ...
                <section class="card">
                  <header class="card-header">
                    <div class="card-actions">
                      	 <a href="<?php echo site_url('Welcome/customerList');?>" class="btn btn-danger">Back</a>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-lg-8">
                        <form name="frm_upt_admin" id="frm_upt_admin" method="post" action="" enctype="multipart/form-data">
                          <table class="table">
                        <thead>
                           <tr>

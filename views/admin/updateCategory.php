            ...
            <div class="card col-sm-12">
              <div class="card-body">
                <?php if($this->session->flashdata('success')!=""){?>
                    ...
                    <?php }?>
                <form  name="f1" action="<?php  echo site_url('backend/Category/updateCategory/'.base64_encode($catInfo[0]['category_id'])); ?>"    enctype="multipart/form-data"  method="post">
                              <div class="row">
                              ...
                              <div class="row form-group " style="padding: 10px;">
                                  ...
                                  <div class="col-sm-12">
                                    <input type="hidden" name="txt_pic" id="txt_pic" value="<?php echo $catInfo[0]['category_image'];?>">
                                    ...
                                    <div class="col-sm-12 form-group">
                                      <img  id="thumb"  width="100px" height="100px" title="Image" src="<?php echo base_url('assets/category/').$catInfo[0]['category_image'];?>" />
                                  </div>
                                  <div class="col-sm-8 form-group">
                                    <label>Category Name</label>
                                    <input type="text" name="category_name" id="category_name" class="form-control " placeholder="Enter Category Name"  value="<?php echo $catInfo[0]['category_name'];?>">
                                  </div>
                                ...
                                <div class="row" style="padding: 10px;">
                                  <div class="col-lg-6  col-md-6 col-xs-6">
                                    <button id="btn_updatecategory" name="btn_updatecategory" type="submit" class="btn btn-primary" >Submit</button>

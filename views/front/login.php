    ...
    <div class="row d-flex justify-content-center align-items-center h-100" style="padding:20px;">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
      	 <?php if($this->session->flashdata('success')!=""){?>
						...
						<?php }?>
        <form class="mt-4" action="<?php echo site_url('Welcome/login');?>" name="frm_login" id="frm_login" method="post">
         ...
         <br/>
          ...
          <div class="form-outline mb-4">
            <input type="email" name="username" id="username" id="form3Example3" class="form-control form-control-lg"
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <button type="submit" class="btn btn-primary " name="btn_login" 
              style="padding-left: 2.5rem; padding-right: 2.5rem;padding: 10px;">Login</button>
            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="<?php echo base_url().'Welcome/register'?>"
